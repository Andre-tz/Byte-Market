        ...
        <main className="mx-auto w-[min(1000px,94%)] space-y-6 py-8">
            ...
            <section className="rounded-2xl border border-slate-800 bg-slate-900/50 p-5 shadow-[0_0_30px_rgba(15,23,42,0.3)] sm:p-6">
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-end">
                    <button className="cursor-pointer rounded-xl border border-cyan-400/35 bg-slate-950/80 px-5 py-2.5 text-sm font-semibold text-cyan-300 transition hover:border-cyan-300 hover:bg-slate-800 hover:text-cyan-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/70">Editar perfil</button>
                    <button className="cursor-pointer rounded-xl bg-cyan-400 px-5 py-2.5 text-sm font-semibold text-slate-950 shadow-[0_14px_30px_rgba(34,211,238,0.18)] transition hover:bg-cyan-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/70">Guardar cambios</button>
                </div>
            </section>
